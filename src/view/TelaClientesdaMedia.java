 ...
 * @author Kaua Semenov
 */
public class TelaClientesdaMedia extends javax.swing.JFrame {

    /** Creates new form Resultado */
    public TelaClientesdaMedia() {
        initComponents();
    ...
    public void readJTable(){
        ...
        for(Cadastro c: cdao.readclientesmedia()){
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaClientesdaMedia().setVisible(true);
            }
        });
    }
